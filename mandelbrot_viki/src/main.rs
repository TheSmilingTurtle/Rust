...
fn pixel_to_point(bounds : (usize, usize), pixel : (usize, usize), upper_left : Complex<f64>, lower_right : Complex<f64>) -> Complex<f64>
{
    ...
    Complex { re: upper_left.re + pixel.0 as f64 * width / bounds.0 as f64,
             im: upper_left.im - pixel.1 as f64 * height / bounds.1 as f64 } // return value
} 
...
fn write_image(filename : &str, pixels : &[u8], bounds : (usize, usize)) -> Result<(), std::io::Error> // success is the unit type
{
